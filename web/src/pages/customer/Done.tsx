  ...
  return (
    <Layout title="Receipt">
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '28px 24px', gap: 20 }}>
        ...
        {/* Check mark */}
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12, animation: 'fade-up 0.35s ease' }}>
          <div style={{
        ...
        {p ? (
          <div style={{
            ...
            animation: 'fade-up 0.35s 0.07s ease both',
          }}>
            ...
            {/* Fare breakdown rows — i and arr now in scope */}
            ...
            <div style={{
              padding: '16px 20px',
              borderTop: '1px solid #f0f0ee', borderBottom: '1px solid #f0f0ee',
              display: 'flex', alignItems: 'center', justifyContent: 'space-between',
            }}>
              <span style={{ fontFamily: 'Geist Mono, monospace', fontSize: 13, fontWeight: 500, color: '#1a1a18' }}>Total</span>
          ...
          <div style={{ background: '#fff', border: '1px solid #e8e6e1', borderRadius: 14, padding: '24px', textAlign: 'center' }}>
            <p style={{ fontFamily: 'Geist Mono, monospace', fontSize: 13, color: '#7a7a74' }}>
              Job complete. Receipt is being generated.
            </p>
          </div>
        )}
        ...
        <button
          onClick={handleDone}
          style={{
            height: 52, background: '#1a5c3a', border: 'none', borderRadius: 10,
            color: '#fff', fontFamily: 'Geist Mono, monospace', fontSize: 14,
            fontWeight: 500, cursor: 'pointer',
            animation: 'fade-up 0.35s 0.14s ease both',
          }}
        >
          Done
        </button>
